...
#define USER_DEBUG0_Pin GPIO_PIN_1
#define USER_DEBUG0_GPIO_Port GPIOA
#define FIFO_WMARK_Pin GPIO_PIN_2
#define FIFO_WMARK_GPIO_Port GPIOA
#define FIFO_WMARK_EXTI_IRQn EXTI2_IRQn
#define FIFO_OVFL_Pin GPIO_PIN_3
